...
class OverlaysView extends React.Component {
	...
	render() {
		/* return (<div id="overlays-container" className="overlays-container-fluid" style={{ padding: '0' }} >
      <div id="overlays-mainContent" className="row" style={{ backgroundColor: '#101B2B', color: 'white', margin: 'auto' }}>
